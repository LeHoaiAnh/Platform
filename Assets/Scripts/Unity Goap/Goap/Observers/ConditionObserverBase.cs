...
{
    public interface IConditionObserver : global::Goap.Resolver.Interfaces.IConditionObserver
    {
    ...
    public abstract class ConditionObserverBase : IConditionObserver
    {
        ...
        public bool IsMet(global::Goap.Resolver.Interfaces.ICondition condition)
        {
