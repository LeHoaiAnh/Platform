...
namespace Hiker.GUI
{
    ...
    {
        public TMP_Text lblContent, titleText;
        ...
        private void Init(string content, System.Action yes_action, System.Action no_action, bool hasNoBtn, string accept_label, string title = "")
        {
            ...
            this.btnAccept.GetComponentInChildren<TMPro.TMP_Text>().text = string.IsNullOrEmpty(accept_label) ? Localization.Get("ok") : accept_label;
            
            this.btnCancel.gameObject.SetActive(hasNoBtn);
            if (hasNoBtn)
            {
                this.btnCancel.GetComponentInChildren<TMPro.TMP_Text>().text = "Cancel";
            }
